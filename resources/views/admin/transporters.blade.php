                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="d-flex align-items-center gap-2">
                                                                {{-- <img class="rounded-circle"
                                                                    src="{{ asset('Transporter/profile/image/' . $item->image) }}"
                                                                    width="40" height="40" alt="Transporter Image"> --}}
                                                                <img class="rounded-circle"
                                                                    src="{{ $item->image ? asset('Transporter/profile/image/' . $item->image) : asset('assets/img/no-img.jpeg') }}"
                                                                    width="40" height="40" alt="Transporter Image">
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="{{ route('transporeter.detail', ['id' => $item->id]) }}"
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <a href="{{ route('transporter.delete', ['id' => $item->id]) }}"
